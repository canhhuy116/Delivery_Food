...
// UID is a method to generate unique id for each object
// its structure contains 62 bits: LocalID (32 bits) + ObjectType (
//10 bits) + ShardID (18 bits)
...
// FromBase58 string -> call DecomposeUID or string -> base 58 . decode -> int64 -> more bit -> uid
